import { TableServiceFactory, TableState } from '../../types';
...
export const selectRowService: TableServiceFactory<SelectRowService> = function (getState, updateState, _getData) {
    const getData = () => {
