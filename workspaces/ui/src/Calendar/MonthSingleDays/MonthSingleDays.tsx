...
export const MonthSingleDays: React.FC<MonthSingleProps<Date | Date[]>> = (
    props: MonthSingleProps<Date | Date[]>
): JSX.Element => {
    const {
        date,
        disabledDates,
    ...
    const monthDays = useMemo(() => {
        return days.map((day: DateItem, index: number) => {
            ...
            const canChange = !type.some(
                (value: DayType) => value === DayType.DISABLED || value === DayType.NOT_ACTIVE
            );
