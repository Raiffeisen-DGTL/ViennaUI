...
export interface Shield2Props extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const Shield2: React.FC<Shield2Props> = (props): JSX.Element => {
