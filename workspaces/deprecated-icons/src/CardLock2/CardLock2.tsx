...
export interface CardLock2Props extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const CardLock2: React.FC<CardLock2Props> = (props): JSX.Element => {
...
CardLock2.defaultProps = {
    size: 'm',
    color: 'currentColor',
};

CardLock2.displayName = 'CardLock2';
export default CardLock2;
