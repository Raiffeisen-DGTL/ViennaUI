...
export interface FireHouseProps extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const FireHouse: React.FC<FireHouseProps> = (props): JSX.Element => {
...
FireHouse.defaultProps = {
    size: 'm',
    color: 'currentColor',
};

FireHouse.displayName = 'FireHouse';
