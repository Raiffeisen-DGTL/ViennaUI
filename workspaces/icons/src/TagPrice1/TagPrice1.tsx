...
export interface TagPrice1Props extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const TagPrice1: React.FC<TagPrice1Props> = (props): JSX.Element => {
...
TagPrice1.defaultProps = {
    size: 'm',
    color: 'currentColor',
};

TagPrice1.displayName = 'TagPrice1';
export default TagPrice1;
