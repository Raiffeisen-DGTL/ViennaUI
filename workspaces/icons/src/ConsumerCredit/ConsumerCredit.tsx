...
export interface ConsumerCreditProps extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const ConsumerCredit: React.FC<ConsumerCreditProps> = (props): JSX.Element => {
...
ConsumerCredit.defaultProps = {
    size: 'm',
    color: 'currentColor',
};

ConsumerCredit.displayName = 'ConsumerCredit';
