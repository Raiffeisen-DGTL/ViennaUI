...
export interface ChatAskRaifProps extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const ChatAskRaif: React.FC<ChatAskRaifProps> = (props): JSX.Element => {
