...
export interface DocProps extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const Doc: React.FC<DocProps> = (props): JSX.Element => {
