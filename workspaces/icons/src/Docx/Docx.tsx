...
export interface DocxProps extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const Docx: React.FC<DocxProps> = (props): JSX.Element => {
