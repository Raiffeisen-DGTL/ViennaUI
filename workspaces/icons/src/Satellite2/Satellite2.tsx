...
export interface Satellite2Props extends SVGAttributes<SVGElement> {
    [key: string]: any;
...
export const Satellite2: React.FC<Satellite2Props> = (props): JSX.Element => {
...
Satellite2.defaultProps = {
    size: 'm',
    color: 'currentColor',
};

Satellite2.displayName = 'Satellite2';
