...
describe('SelectRow service', () => {
    ...
    test('toggleSelectRow', () => {
        // select '2'
        service.toggleSelectRow('2', { isSelect: true });
        expect(serviceId).toEqual(SelectRowModule.name);
        expect(newState.selectRow.selected).not.toBeUndefined();
        ...
        // deselect 3
        service.toggleSelectRow('3', { isSelect: false });
        expect(newState.selectRow.selected).not.toBeUndefined();
        ...
        // select all
        service.toggleSelectRow(SELECT_ALL, { isSelect: true });
        expect(newState.selectRow.selected).not.toBeUndefined();
        selected = newState.selectRow.selected;
        ...
        // deselect all
        service.toggleSelectRow(SELECT_ALL, { isSelect: false });
        expect(newState.selectRow.selected).not.toBeUndefined();
        selected = newState.selectRow.selected;
