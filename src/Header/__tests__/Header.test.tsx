...
describe('Header', () => {
    ...
    describe('Desktop view', () => {
        ...
        it('should active submenu point', async () => {
            const { rerender } = render(headerFactory(false, 'score'));
            // get requsites item
            const requisitesItem = screen.getByText(/Реквизиты/i);
            // click to requsites item
            ...
            await userEvent.click(subMenuPoint);
    ...
    describe('Mobile view', () => {
        ...
        it('should be open burger menu', async () => {
            ...
            // buttons = 1 close button and 3 menu points (score, operations, requisites)
        ...
        it('should handle submenu point', async () => {
            const { rerender } = render(headerFactory(false, 'score', true));
            ...
            await userEvent.click(requisites);
            ...
            await userEvent.click(mobileSubmenuPoint);
            expect(handleClick).toBeCalledTimes(1);
        });

        it('should open submenu and come back to menu', async () => {
            const { rerender } = render(headerFactory(false, 'score', true));
            ...
            await userEvent.click(backToMenu);
